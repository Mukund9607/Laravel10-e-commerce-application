                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-start ">
                                                ...
                                                <img src="{{ asset($item->options->image) }}" width="" height="">
                                                @endif
                                                <h2>{{ $item->name }}</h2>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-danger del" data-id="{{ $item->rowId }}" ><i class="fa fa-times"></i></button>
                                        </td>
                                    </tr>
                                    @endforeach                                
                                </tbody>
...
<script>
    $('.add').click(function(){
      ...
      if (qtyValue < 10) {
        ...
        var new_qty = qtyElement.val();
          updateCart(rowId,new_qty)
      }            
  });
  ...
  function updateCart(rowid,qty){
    $,$.ajax({
        ...
        success: function (response) {
            ...
            if(response.message === 'cart update successfully'){
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            ...
            alert('An error occurred while updating the product to the cart.');
        }
    });
  }
