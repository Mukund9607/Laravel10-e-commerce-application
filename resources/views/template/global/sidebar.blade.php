<ul id="account-panel" class="nav nav-pills flex-column" >
    ...
    <li class="nav-item">
        <a href="{{ route('logout_user') }}" class="nav-link font-weight-bold" role="tab" aria-controls="tab-register" aria-expanded="false"><i class="fas fa-sign-out-alt"></i> Logout</a>
    </li>
</ul>